...
Проект представляет собой API-сервис на FastAPI для расчёта диапазонов наказаний по данным статьи и параметрам дела/лица. Логика расчёта портирована из FoxPro-правил (в т.ч. расчёт сроков, ограничений и текстовых формулировок), а справочные данные подтягиваются из табличного файла `справочник_УК_обновленный_2025_06_07_1.txt`.
